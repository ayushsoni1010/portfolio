...
\small{\item{
      ...
      \vspace{3pt}\textbf{UI Component Libraries/CSS}{: \hfill Chakra UI, Shadcn UI, Radix UI, Ant Design, Material UI, styled-components, TailwindCSS} \\
      \vspace{3pt}\textbf{Databases/Servers}{: \hfill Firebase, Supabase, MongoDB, MySQL, PostgreSQL, Redis, Prisma, Nginx} \\
      \vspace{3pt}\textbf{Platforms/Tooling}{: \hfill AWS, Docker, Vercel/Netlify, Webpack, Vite, GitHub Actions} \\
